      ...
      {isDetail ? (projectSlug === 'news-cms' ? <StructureProjectDetail /> : projectSlug === 'member-system' ? <MemberSystemDetail /> : projectSlug === 'health-chatbot' ? <HealthChatbotDetail /> : <ProjectDetail />) : <main>
        <div className="portfolio-stage">
          ...
          <section className="hero" id="about">
            <HeroRoleCarousel />
            <p data-reveal>I'm Lan, a Senior Product Designer with 10+ years of experience designing digital products across healthcare, fintech, wellness, media, and AI.</p>
          </section>
