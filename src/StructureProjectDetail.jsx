...
export default function StructureProjectDetail() {
  return <main className="project-detail cms-detail cms-redesign">
    <section className="detail-intro cms-hero">
      ...
      <div className="detail-intro__copy">
        <p>TVBS News CMS 是一套使用近二十年的新聞編輯後台，同時服務編輯、記者與業務。隨著內容需求持續增加，原有系統逐漸難以支撐現在的工作流程；但對每天高度依賴它的團隊而言，全面改版也意味著重新學習的成本。因此，本次改版從保留既有習慣出發，重新建立可持續擴展的內容管理系統。</p>
      ...
      <div className="detail-goal-split cms-redesign__goal">
        <div className="detail-hero cms-hero__image" data-image-reveal><img src="/assets/figma/structure-source.png" alt="TVBS News CMS 系統畫面" /></div>
        <div className="detail-mobile-goal"><small>Project Goal</small><strong>建立可擴展的<br />後台內容管理系統</strong></div>
      </div>
    </section>

    <section className="cms-redesign__section cms-redesign__original">
      <h2>Original CMS</h2>
      <figure data-image-reveal><img src="/assets/detail/cms_1.jpg" alt="原有 CMS 編輯器介面" /></figure>
      <p>TVBS 新聞 CMS 使用超過二十年，隨著新聞產製流程與內容型態持續增加，原有系統逐漸變得複雜。此次改版從使用者熟悉的工作方式出發，保留必要操作邏輯，重新梳理內容層級、元件規則與操作流程。</p>
    </section>
    ...
    <section className="cms-redesign__section cms-redesign__system">
      ...
      <div className="cms-redesign__system-block">
        ...
        <div className="cms-redesign__system-content">
          <h3>選用 Tailwind Color 作為基礎色票。</h3>
      ...
      <div className="cms-redesign__system-block">
        <span>Icon</span>
        <div className="cms-redesign__icons"><p>選用 Lucide Icons，建立一致且可延展的圖示系統。</p><img src="/assets/detail/cms_2.jpg" alt="CMS icon 系統" /></div>
      </div>
    </section>
    ...
    <section className="cms-redesign__dark">
      <div className="cms-redesign__dark-section">
        <h2>Components</h2>
        <p className="cms-redesign__dark-subtitle">以 shadcn/ui 為基礎，延展全站共用元件系統</p>
        <img src="/assets/detail/cms_3.jpg" alt="CMS 元件設計" />
      </div>
      <div className="cms-redesign__dark-section">
        <h2>Flow</h2>
        <img src="/assets/detail/cms_4.jpg" alt="CMS 關鍵操作流程" />
      </div>
      <div className="cms-redesign__dark-section cms-redesign__pages">
        <h2>Pages</h2>
        <img className="cms-redesign__pages-image" src="/assets/detail/cms_5.jpg" alt="CMS 頁面設計" />
      </div>
    </section>
    <SiteFooter />
  </main>
